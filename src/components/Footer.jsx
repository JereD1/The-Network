...
const Footer = () => {
  return (
    <div className='bg-black'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-start gap-10 px-4 sm:px-10 lg:px-40 py-10 text-white'>
        <div className='flex flex-col'>
          <img src={MainNetworkLogo} alt="The Network Logo" className='w-28 invert mb-4' />
        ...
        <div className='flex flex-col justify-center items-center'>
          <div className='bg-white px-4 py-6 rounded-lg w-auto'>
            <h1 className='text-black mb-4 font-bold'>Subscribe to our newsletter</h1>
            <form action="">
              <div className="mb-4">
